  ...
  <div>
    ...
    >
      <template v-if="item.type === 'folder'">
        <ChevronRight v-if="!item.expanded" :size="16" class="text-muted-foreground flex-shrink-0" />
        <ChevronDown v-else :size="16" class="text-muted-foreground flex-shrink-0" />
        <Folder :size="16" class="text-muted-foreground flex-shrink-0" />
      </template>
      <File v-else :size="16" class="text-muted-foreground flex-shrink-0" />
