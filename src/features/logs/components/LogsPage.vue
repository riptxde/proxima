        ...
        <div class="flex items-center justify-between">
          ...
          >
            ...
            >
              ...
              />
              <Badge variant="outline" class="text-xs bg-tab-bar select-none">
                {{ getLevelCount(level) }}
              </Badge>
            </div>
          </div>
          <div class="flex items-center gap-2">
            <div class="relative w-64">
              ...
              <Input
                ...
                @update:model-value="(value) => setSearchFilter(String(value))"
                placeholder="Search"
                class="pl-9 h-9"
              />
            </div>
            <Button variant="outline" size="icon" @click="clearLogs">
