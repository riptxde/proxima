  ...
  <div class="p-5 space-y-4">
      ...
      <div class="flex items-center gap-2 flex-wrap">
        ...
        >
          <span
            ...
            >Time</span
          >
          <span class="text-xs font-mono">{{ formatTime(call.timestamp) }}</span>
        </div>
      ...
      <div v-if="call.callingScript">
        ...
        >
          <div
            class="text-xs font-mono break-all leading-relaxed text-foreground/90"
          >
            {{ call.callingScriptPath || call.callingScript }}
          </div>
        </div>
      </div>
    </div>
    ...
    <div v-if="call.returnValue" class="space-y-3">
      ...
      >
        ...
        >
          <div class="flex items-center gap-2">
            <span class="text-xs font-mono font-semibold text-green-400"
              >return</span
            >
