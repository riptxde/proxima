            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between py-1.5">
                <div class="space-y-0 select-none">
                  <Label for="word-wrap" class="text-sm cursor-pointer">
                    Word Wrap
                  </Label>
                ...
                <Switch id="word-wrap" v-model="editorSettings.wordWrap" />
              </div>
              ...
              <div class="flex items-center justify-between py-1.5">
                <div class="space-y-0 select-none">
                  <Label for="minimap" class="text-sm cursor-pointer">
                    Minimap
                  </Label>
                  <p class="text-xs text-muted-foreground font-normal">
                ...
                <Switch id="minimap" v-model="editorSettings.minimap" />
              </div>
              ...
              <div class="space-y-2 py-1.5">
                <div class="space-y-0 select-none">
                  <Label for="font" class="text-sm"> Font </Label>
                  <p class="text-xs text-muted-foreground font-normal">
                    Editor font family
                  </p>
                </div>
              ...
              <div class="flex items-center justify-between py-1.5">
                <div class="space-y-0 select-none">
                  <Label for="font-ligatures" class="text-sm cursor-pointer">
                    Font Ligatures
                  </Label>
                  <p class="text-xs text-muted-foreground font-normal">
              ...
              <div class="flex items-center justify-between py-1.5">
                <div class="space-y-0 select-none">
                  <Label for="smooth-cursor" class="text-sm cursor-pointer">
                    Smooth Cursor
                  </Label>
                  <p class="text-xs text-muted-foreground font-normal">
        ...
        <Card class="p-4">
          <div class="space-y-3">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between py-1.5">
                <div class="space-y-0 select-none">
                  <Label for="auto-execute" class="text-sm cursor-pointer">
                    Auto Execute
                  </Label>
                  <p class="text-xs text-muted-foreground font-normal">
                    Automatically execute AutoExec scripts when clients attach
                  </p>
                </div>
                <Switch
                  id="auto-execute"
              ...
              <div class="flex items-center justify-between py-1.5">
                <div class="space-y-0 select-none">
                  ...
                  <p class="text-xs text-muted-foreground font-normal">
                    Allow script execution from external HTTP requests
                  </p>
                </div>
                <Switch
                  id="http-request-execution"
                  v-model="executionSettings.httpRequestExecution"
                />
              </div>
            </div>
          </div>
        ...
        <Card class="p-4">
          <div class="space-y-3">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between py-1.5">
                <div class="space-y-0 select-none">
                  <Label for="always-on-top" class="text-sm cursor-pointer">
                    Always on Top
                  </Label>
                  <p class="text-xs text-muted-foreground font-normal">
