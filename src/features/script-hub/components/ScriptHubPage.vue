      ...
      <div class="flex-1 overflow-y-auto p-6">
        <div v-if="isLoading" class="flex items-center justify-center h-64">
          <div class="flex flex-col items-center gap-3 select-none">
            ...
            <p class="text-sm text-muted-foreground">Loading scripts...</p>
          </div>
        </div>

        <div v-else-if="error" class="flex items-center justify-center h-64">
          <div class="text-center space-y-2 select-none">
            <p class="text-destructive font-medium">Failed to load scripts</p>
        ...
        >
          <div class="text-center space-y-2 select-none">
            <p class="text-foreground font-medium">No scripts found</p>
